...
function twentyseventeen_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => __( '双栏主题', 'twentyseventeen' ),
...
function twentyseventeen_pingback_header() {
	printf('<link rel="stylesheet" href="//cdn.bootcss.com/font-awesome/4.7.0/css/font-awesome.css">'."\n");
}
...
function twentyseventeen_scripts() {
	...
	wp_enqueue_script( 'None', get_theme_file_uri( '/assets/js/SmoothScroll.js' ), array(), '1.0', true );
...
//默认开启评论
function wp_open_comments_for_pages( $status, $post_type, $comment_type ) {
    if ( 'page' === $post_type ) {
        $status = 'open';
    }
    return $status;
}
add_filter( 'get_default_comment_status', 'wp_open_comments_for_pages', 10, 3 );

//禁止加载默认jq库
function my_enqueue_scripts(){
    wp_deregister_script('jquery');
    wp_register_script('jquery', ("https://cdn.bootcss.com/jquery/2.2.4/jquery.min.js"), false);
